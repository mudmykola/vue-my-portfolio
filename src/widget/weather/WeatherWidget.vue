...
<template>
  <div
    class="weather flex items-center p-[10px] rounded-[10px]"
    v-if="!loading && weatherIconUrl"
  >
    <div class="weather-info flex items-center text-[16px]">
      ...
      <p class="temperature text-[24px] font-bold text-default ml-5">
  ...
  <div class="text-default" v-else>Loading...</div>
</template>
