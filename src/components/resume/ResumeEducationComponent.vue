...
<div class="education mt-5">
  <div class="education-title global-title text-2xl font-bold">
    <h2>{{ educationTitle }}</h2>
  </div>
<div class="education-inner w-[400px] mt-5">
  <ul class="gap-5 flex flex-col">
    <li v-for="(item, index) in items" :key="index">
      <div class="education-item">
        <div class="education-year text-default text-[13px] font-bold">{{ item.year }}</div>
